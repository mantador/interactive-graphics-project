...
function main() {
  ...
  // }
  spheres.push(new Sphere({ center: {x: 200, y: 300, z: 500}, velocity: {x: 3, y: 0.3, z: 0}, mass: 20 }))
  spheres.push(new Sphere({ center: {x: 800, y: 300, z: 500}, velocity: {x: 0, y: 0, z: 0}, mass: 80 }))
